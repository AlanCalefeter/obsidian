...
- **Le langage de requête de données** (DQL) pour l'interrogation des données.
	- **Data Manipulation Language** (DML) pour la modification des données.
